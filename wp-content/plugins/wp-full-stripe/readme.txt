...
IMPORTANT: WP Full Stripe v4.0+ requires PHP 5.5 or greater
IMPORTANT: WP Full Stripe v4.0+ has new a form design, it's not compatible with the old design. Your custom CSS rules won't work.
UPDATE ONLY IF you have tested v4.0+ in your test/staging environment.

* NEW! Professional, new look for all form types
* NEW! Professional, new look for the "Manage subscriptions" page
* NEW! Inline forms now use Stripe Elements for collecting card details
* NEW! Subscription forms can display plans as radio button list or dropdown
* NEW! Subscription forms have a new "Payment details" popover for subscription overview (setup fee, plan, VAT, total)
* NEW! One-time payment forms can display amounts as radio button list or dropdown
* NEW! Donation look for one-time payments
